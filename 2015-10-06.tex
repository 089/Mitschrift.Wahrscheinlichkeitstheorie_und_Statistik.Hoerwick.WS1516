...
Einzelexperiment mit Ergebnismenge $ \Omega $ wird n mal wiederholt. Dadurch entsteht ein Datenvektor\index{Datenvektor} $ (\omega_1, \omega_2, ..., \omega_), \omega_i \in \Omega $. \profnote{Dieser Datenvektor steht fest und kann nachträglich nicht mehr geändert werden.} Jedem Ereignis A von $ \Omega $ können wir eine relative Häufigkeit zuordnen: $ r(A) = |\{ j : 1\leq j\leq n \textrm{und} \omega_j \in A \}| \cdot \frac{1}{n} $. 
